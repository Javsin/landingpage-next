        ...
        <div className="row">
          ...
          <div className="col-xl-7 col-lg-6 icon-boxes d-flex flex-column align-items-stretch justify-content-center py-5 px-lg-5" data-aos="fade-left">
            ...
            <div className="icon-box" data-aos="zoom-in" data-aos-delay={300}>
              ...
              <p className="description">Bangun jaringanmu untuk bonus komisi lebih besar.</p>
            </div>
            <div className="icon-box" data-aos="zoom-in" data-aos-delay={300}>
              <div className="icon">
              ...
              <p className="description">98,38% pesan direspon CS dalam waktu maksimal 45 detik.</p>
            </div>
          </div>
        </div>
      </div>
