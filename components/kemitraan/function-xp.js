        ...
        <section className="functional-xp">
          <div className="container">
            <div className="row">
              ...
              <div className="col-8 offset-2">
                <p className="px-5 fw-400 text-center text-dark-blue">
                  XP (Experience Point) adalah poin yang Mitra peroleh setelah melakukan aktivitas tertentu
                  di dalam aplikasi MuraPay. Mitra harus mengumpulkan beberapa jumlah XP
                  sebagai syarat untuk naik level.
                </p>
              </div>
                ...
                <div className="accordion accordion-flush custom-accordion" id="accordionFlushExample">
                      ...
                      <button className="accordion-button collapsed fw-700 text-orange" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseOne" aria-expanded="false" aria-controls="flush-collapseOne">
                        <div className="row w-100 d-flex">
                          <div className="col-1 text-center">
                            <div className="circle2 bg-white text-dark-blue fw-400 fs-5">
                              A
                            </div>
                          </div>
                          <div className="col-11 align-self-center fs-5">
                            Mendaftar dengan Kode Refferal
                          </div>
                        </div>
                      </button>
                    </h2>
                      ...
                      <button className="accordion-button collapsed fw-700 text-orange" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseTwo" aria-expanded="false" aria-controls="flush-collapseTwo">
                        <div className="row w-100 d-flex">
                          ...
                          <div className="col-11 align-self-center">
                            <p className="my-0 d-flex fs-5">Transaksi Mitra <span className="text-white mx-2">+10-500</span> <Image src={xp} width={18} height={18} /></p>
                          </div>
                        </div>
                      </button>
                    </h2>
                  ...
                  <div className="accordion-item mb-2">
                    <h2 className="accordion-header" id="flush-headingThree">
                      <button className="accordion-button collapsed fw-700 text-orange" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseThree" aria-expanded="false" aria-controls="flush-collapseThree"><div className="row w-100 d-flex">
                          <div className="col-1 text-center">
                            <div className="circle2 bg-white text-dark-blue fw-400 fs-5">
                              C
                            </div>
                          ...
                          <div className="col-11 align-self-center">
                            <p className="my-0 d-flex fs-5">XP Starter  <span className="text-white mx-2">+50-500</span> <Image src={xp} width={18} height={18} /></p>
                          </div>
                        </div>
                      </button>
                    </h2>
                      ...
                      <div className="accordion-body pt-0 text-dark-blue">
                        <div className="row">
                          <div className="col-12">
                            <p className="mt-2">
                              Menyelesaikan misi XP Starter dalam kurun waktu satu minggu (7 hari) setelah mendaftar
                            </p>
                          </div>
                          ...
                          <div className="col-2 text-orange fw-700">
                            <p className="my-0">
                              +50 <span className="ms-2 align-self-center"><Image src={xp_biru} width={18} height={18} /></span>
                            </p>
                          </div>
                          <div className="col-10">
                            <span className="my-0 d-flex">
                          ...
                          <div className="col-2 fw-700 text-orange">
                            <p className="my-0">
                              +250 <span className="ms-2 align-self-center"><Image src={xp_biru} width={18} height={18} /></span>
                            </p>
                          </div>
                        </div>
                      </div>
                  ...
                  <div className="accordion-item mb-2">
                    <h2 className="accordion-header" id="flush-headingFour">
                      <button className="accordion-button collapsed fw-700 text-orange" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseFour" aria-expanded="false" aria-controls="flush-collapseFour"><div className="row w-100 d-flex">
                          <div className="col-1 text-center">
                            <div className="circle2 bg-white text-dark-blue fw-400 fs-5">
                              D
                            </div>
                      ...
                      <div className="accordion-body pt-0 text-dark-blue">
                        <div className="row">
                          ...
                          <div className="col-8 text-orange fw-700">
                            <p className="my-0">
                              +200 <span className="ms-2 align-self-center"><Image src={xp_biru} width={18} height={18} /></span>
                            </p>
                          </div>
                          <div className="col-4">
                            <span className="my-0 d-flex">
                          ...
                          <div className="col-8 fw-700 text-orange">
                            <p className="my-0">
                              +300 <span className="ms-2 align-self-center"><Image src={xp_biru} width={18} height={18} /></span>
                            </p>
                          </div>
                          <div className="col-4">
                            <span className="my-0 d-flex">
                          ...
                          <div className="col-8 fw-700 text-orange">
                            <p className="my-0">
                              +400 <span className="ms-2 align-self-center"><Image src={xp_biru} width={18} height={18} /></span>
                            </p>
                          </div>
                          <div className="col-4">
                            <span className="my-0 d-flex">
                          ...
                          <div className="col-8 fw-700 text-orange">
                            <p className="my-0">
                              +500 <span className="ms-2 align-self-center"><Image src={xp_biru} width={18} height={18} /></span>
                            </p>
                          </div>
                        </div>
                      </div>
                  ...
                  <div className="accordion-item mb-2">
                    <h2 className="accordion-header" id="flush-headingFive">
                      <button className="accordion-button collapsed fw-700 text-orange" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseFive" aria-expanded="false" aria-controls="flush-collapseFive"><div className="row w-100 d-flex">
                          <div className="col-1 text-center">
                            <div className="circle2 bg-white text-dark-blue fw-400 fs-5">
                              E
                            </div>
                      ...
                      <div className="accordion-body pt-0 text-dark-blue">
                        <div className="row">
                          ...
                          <div className="col-3 text-orange fw-700 mt-2">
                            <p className="my-0">
                              +150 <span className="ms-2 align-self-center"><Image src={xp_biru} width={18} height={18} /></span>
                            </p>
                          </div>
                          <div className="col-9">
                            <span className="my-0 d-flex">
                          ...
                          <div className="col-3 fw-700 text-orange">
                            <p className="my-0">
                              +10-500 <span className="ms-2 align-self-center"><Image src={xp_biru} width={18} height={18} /></span>
                            </p>
                          </div>
                          <div className="col-9">
                            <span className="my-0 d-flex">
                          ...
                          <div className="col-3 fw-700 text-orange">
                            <p className="my-0">
                              +20 -200 <span className="ms-2 align-self-center"><Image src={xp_biru} width={18} height={18} /></span>
                            </p>
                          </div>
                                ...
                                <div className="row m-2">
                                  <div className="col-2 py-2 bg-white border-radius-24-top-left border-light-gray-bottom border-light-gray-right">
                                    <div className="rounded-pill bg-dark-blue text-center">
                                      <p className="my-0 fs-7 fw-500">Upline <br /> Tk. 4</p>
                                    </div>
                                  </div>
                                  ...
                                  <div className="col-2 py-2 border-light-gray-bottom border-light-gray-right bg-light-gray d-flex align-items-center justify-content-center">
                                    <p className="my-0 fs-7 text-dark-blue align-self-center fw-500">+10 % dari <br /> XP Mitra</p>
                                  </div>
                                  <div className="col-2 py-2 border-light-gray-bottom border-light-gray-right bg-light-gray d-flex align-items-center justify-content-center">
                                    <p className="my-0 fs-7 text-dark-blue align-self-center fw-500">-</p>
                                  </div>
                                  ...
                                  <div className="col-2 py-2 bg-white border-light-gray-bottom border-light-gray-right">
                                    <div className="rounded-pill bg-dark-blue text-center">
                                      <p className="my-0 fs-7 fw-500">Upline <br /> Tk. 3</p>
                                    </div>
                                  </div>
                                  ...
                                  <div className="col-2 py-2 border-light-gray-bottom border-light-gray-right bg-white d-flex align-items-center justify-content-center">
                                    <p className="my-0 fs-7 text-dark-blue align-self-center fw-500">+20 % dari <br /> XP Mitra</p>
                                  </div>
                                  <div className="col-2 py-2 border-light-gray-bottom border-light-gray-right bg-white d-flex align-items-center justify-content-center">
                                    <p className="my-0 fs-7 text-dark-blue align-self-center fw-500">-</p>
                                  </div>
                                  ...
                                  <div className="col-2 py-2 bg-white border-light-gray-bottom border-light-gray-right">
                                    <div className="rounded-pill bg-dark-blue text-center">
                                      <p className="my-0 fs-7 fw-500">Upline <br /> Tk. 2</p>
                                    </div>
                                  </div>
                                  <div className="col-2 py-2 border-light-gray-bottom border-light-gray-right bg-light-gray d-flex align-items-center justify-content-center">
                                    <p className="my-0 fs-7 text-dark-blue align-self-center fw-500">-</p>
                                  ...
                                  <div className="col-2 py-2 border-light-gray-bottom border-light-gray-right bg-light-gray d-flex align-items-center justify-content-center">
                                    <p className="my-0 fs-7 text-dark-blue align-self-center fw-500">+30 % dari <br /> XP Mitra</p>
                                  </div>
                                  <div className="col-2 py-2 border-light-gray-bottom border-light-gray-right bg-light-gray d-flex align-items-center justify-content-center">
                                    <p className="my-0 fs-7 text-dark-blue align-self-center fw-500">-</p>
                                  </div>
                                  ...
                                  <div className="col-2 py-2 bg-white border-light-gray-bottom border-light-gray-right">
                                    <div className="rounded-pill bg-dark-blue text-center">
                                      <p className="my-0 fs-7 fw-500">Upline <br /> Tk. 1</p>
                                    </div>
                                  </div>
                                  <div className="col-2 py-2 border-light-gray-bottom border-light-gray-right bg-white d-flex align-items-center justify-content-center">
                                  ...
                                  <div className="col-2 py-2 border-light-gray-bottom border-light-gray-right bg-white d-flex align-items-center justify-content-center">
                                    <p className="my-0 fs-7 text-dark-blue align-self-center fw-500">+40 % dari <br /> XP Mitra</p>
                                  </div>
                                  <div className="col-2 py-2 border-light-gray-bottom border-light-gray-right bg-white d-flex align-items-center justify-content-center">
                                    <p className="my-0 fs-7 text-dark-blue align-self-center fw-500">-</p>
                                  </div>
                                  ...
                                  <div className="col-2 py-2 bg-orange border-radius-24-bottom-right d-flex align-items-center justify-content-center">
                                    <p className="my-0 fs-7 text-white align-self-center fw-500">Misi &amp; Event <br /> di Aplikasi</p>
                                  </div>
                                </div>
                              </div>
                            </div>
                    ...
                    <h2 className="accordion-header" id="flush-headingSix">
                      <button className="accordion-button collapsed fw-700 text-orange" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseSix" aria-expanded="false" aria-controls="flush-collapseSix">
                        <div className="row w-100 d-flex">
                          ...
                          <div className="col-11 align-self-center">
                            <p className="my-0 d-flex fs-5">Misi dan Event <span className="text-white mx-2">+100-500</span> <Image src={xp} width={18} height={18} /> </p>
                          </div>
                        </div>
                      </button>
                    </h2>
