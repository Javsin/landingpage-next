    ...
    return (
        <section id="what-is-mitramura" className="what-is-mitramura py-3 bg-dark-blue">
            <div className="container py-4">
                <div className="row">
                    <div className="col-lg-6 offset-lg-3 d-flex justify-content-center px-0" data-aos="fade-down">
                        <a onClick={props.openBootstrapModal} className="youtube">
                            <Image src = {image1} className={styles.thumbnail_video} unoptimized={true}/>
                        </a>
                    </div>
                </div>
                <div className="col-12 text-center pt-5" data-aos="fade-down">
                    <h4 className="text-orange fs-2 fw-700">Apa itu MitraMura?</h4>
                </div>
                <div className="col-8 offset-2 text-center mb-2" data-aos="fade-down">
                    <p className="text-white fs-5 fw-400 px-5 mb-0">
