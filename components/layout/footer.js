    ...
    <footer id="footer" className="bg-blue-6">
        ...
        <div className="container">
          <div className="row">
            <div className="col-lg-5 col-md-6 mb-3">
              <div className="">
                ...
                <p className="pb-3 my-0">
                  <em>Bangun usahamu sampai ke level tertinggi dengan harga terbaik, produk digital ter-update, dan pelayanan solutif.</em>
                </p>
                <p>
                  Jl. Batan Selatan No.54, Miroto, Kec. Semarang Tengah, <br /> Kota Semarang, Jawa Tengah 50134
                </p>
                <div className="social-links mt-3">
                  <a href="https://www.instagram.com/murapay.id/" target="_blank" rel="noreferrer" className="instagram bg-orange me-2">
            ...
            <div className="col-lg-3 col-md-6 footer-newsletter">
              <h4>Hubungi Kami</h4>
              <a className="text-white" style={{ cursor: "pointer" }} href="https://api.whatsapp.com/send/?phone=6281329701020&text&type=phone_number&app_absent=0" target="_blank" rel="noreferrer">
              ...
              <br />
              <br />
              <a href="mailto:info@murapay.id" className="text-white" target="_blank" rel="noreferrer" style={{ cursor: "pointer" }}>
      ...
      <div>
        <div className="d-none d-md-block">
          ...
          (
            <a onClick={scrolltop} className="back-to-top d-flex align-items-center justify-content-center" id="back-to-top">
          ...
          <div className="row d-flex justify-content-center align-items-center py-3" style={{ paddingLeft: "20px", paddingRight: "20px" }}>
            ...
            <div className="col-5">
              <div className="d-flex flex-column align-self-center">
                <span className="text-white fw-bolder" style={{ fontSize: "1rem" }}>
                  MuraPay
                </span>
              </div>
            </div>
