                    ...
                    <div className="row">
                        <div className="col-12 text-center">
                            <div className="rounded-5 bg-dark-blue p-4">
                                ...
                                <p className="fw-500 text-white d-block d-md-none">
                                ...
                                <p className="fw-700 text-white mb-4 d-block d-md-none">
                                    Hal ini membuat Pemain Konter & Retail Pulsa membatasi pembelanjaannya <br/>
                                    ke Dealer Operator sebagai solusi untuk memitigasi resiko perpajakan <br/>
                                    bagi usaha mereka.
                                </p>
                                <a target="_blank" href="https://jdih.kemenkeu.go.id/download/9ac38d51-3b80-4dfd-a5e3-75a444bc49cc/6~PMK.03~2021Per.pdf" className="text-orange text-decoration-none">
                                    <small>
                        ...
                        <div className="col-md-7 d-flex">
                            <p className="text-dark-blue fs-medium fw-500 align-self-center d-md-block d-none">
                            ...
                            <p className="text-dark-blue fw-500 align-self-center d-block d-md-none text-center mt-2">
