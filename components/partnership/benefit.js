                ...
                <div className="container">
                    ...
                    <div className="row">
                        <div className="col-12 text-center">
                            <Image src={image1} alt="image1" className="img-fluid" width={100} height={100} />
                        ...
                        <div className="col-12 text-center">
                            <Image src={image2} alt="image1" className="img-fluid"  width={100} height={100} />
                        ...
                        <div className="col-12 text-center">
                            <Image src={image3} alt="image1" className="img-fluid" width={100} height={100} />
