                ...
                <div className="container">
                    <div className="row">
                        ...
                        <div className="col-4 text-center">
                            <Image src={icon_1} className="img-fluid" unoptimized={true} alt="benefit-partnership-1"/>
                        ...
                        <div className="col-4 text-center">
                            <Image src={icon_2} className="img-fluid" unoptimized={true} alt="benefit-partnership-1"/>
                        ...
                        <div className="col-4 text-center">
                            <Image src={icon_3} className="img-fluid" unoptimized={true} alt="benefit-partnership-1"/>
