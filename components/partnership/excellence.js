                ...
                <div className="container">
                    <div className="row">
                        ...
                        <div className="col-md-4 col-12 text-center">
                            ...
                            <p className="text-white fw-500 d-none d-md-block">Menambah <br/>Pasar Baru</p>
                        ...
                        <div className="col-md-4 col-12 text-center">
                            ...
                            <p className="text-white fw-500 d-none d-md-block">Push Selling<br/>dalam Aplikasi</p>
                        ...
                        <div className="col-md-4 col-12 text-center">
                            ...
                            <p className="text-white fw-500 d-none d-md-block">Menawarkan Pilihan<br/>Produk Beragam</p>
